...
public interface TaskDao extends Mapper<Task> {
    ...
    @Select({" select",
            ...
            "         e_task.cron,",
            "         e_task.sender_ip,",
            "         e_message.subject as 'email.subject',",
            "         e_message.content as 'email.content',",
            "         e_message.attachment_name as 'email.attachmentName',",
            "         e_message.attachment_path as 'email.attachmentPath',",
            "         GROUP_CONCAT(email separator ' ') as 'email.receiver'",
            "       from e_task",
            "         inner join e_message on e_task.message_id = e_message.id",
            "         inner join l_group_task on e_task.id = l_group_task.task_id",
